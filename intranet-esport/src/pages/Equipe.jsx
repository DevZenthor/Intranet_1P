    ...
    <section className="team-page">
      <div className="container">
        ...
        <div className="team-header text-center">
          ...
          {/* BOUTON AJOUTER — uniquement canManage */}
          {canManage && (
            <button
        ...
        {loading ? (
          <h3 className="text-white text-center">Chargement...</h3>
        ) : (
          <>
        ...
        {/* POPUP AJOUTER — uniquement canManage */}
        {canManage && showAdd && (
        ...
        {/* POPUP MODIFIER — uniquement canManage */}
        {canManage && showEdit && (
          <div className="popup-overlay">
            <div className="popup-box">
